...
class BankingAppGUI(App):
    def build(self):
        ...
        accounts = [
            {"owner": "Blerta Sefaj", "balance": 500.0},
            {"owner": "Ergen Elezaj", "balance": 1000.0},
            {"owner": "Rajan Elezaj", "balance": 1500.0}
        ]
        ...
        for account in accounts:
            ...
            action_button.bind(on_press=lambda instance, acc=account, bal_label=balance_label, act_spinner=action_spinner, amt_input=amount_input:
                               self.perform_action(acc, bal_label, act_spinner.text, amt_input.text))
